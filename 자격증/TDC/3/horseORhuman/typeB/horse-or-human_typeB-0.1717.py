...
def solution_model():
    ...
    transfer_model = efficientnet_v2.EfficientNetV2S(weights='imagenet', include_top=False, input_shape=(300, 300, 3))
...
if __name__ == '__main__':
    ...
    model.save("TF3-horses-or-humans-type-B-0.1717.h5")